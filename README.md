...
## 💻 Recent Development Activity (Most recent active public week: August 24 - 30 2026)
...
* A GitHub profile repository that turns recent public project activity into a compact developer landing page.
...
* A Hugo-powered personal website for publishing a portfolio, link hub, and CV on the web.
...
* **Work:** Software Engineer @ ETH Chair of Education Systems (building `CesBot` - a Next.js RAG chatbot) & ETH Game Technology Center (`Morph Tales`).
* **Other Projects:** Electomate (AI voting advice), SCION routing emulator, Kubernetes Homelab (Proxmox/k3s).

---

## 📫 Connect
- [LinkedIn](https://linkedin.com/in/bruol)
- [GitHub](https://github.com/bruol)
- [bruol.me](https://bruol.me)
